...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-pink text-white navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src= "https://image.freepik.com/free-vector/cute-bakery-chef-girl-welcome-smiling-cartoon-art-illustration-logo_56104-56.jpg"
                width="110"
                height="32"
                alt="Tabler"
